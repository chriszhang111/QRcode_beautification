...
{
	if (!(dlh=LoadLibrary(_T("apclusterwin.dll"))) && warningIfNotLoad) // Download the corresponding dll from (Notice: only 32bit dll is public available at the moment): http://www.psi.toronto.edu/index.php?q=affinity+propagation
